...
orderly_commit(orderly_run("income_boosting_rates", echo = FALSE))

# do runs on all countries except ERI and FSM due to lack of vacination
...
collate_outputs <- function(iso3cs, grouping = NULL, replicates = 100, type = "deaths", over_time = TRUE){
